...
TEST(aclrtMemsetAsync, sanitizer_call_pre_function_with_memset_async_args_expect_return)
{
    ...
    HijackedFuncOfAclrtMemsetAsyncImpl instance;
    instance.Pre(nullptr, 10, 0, 10, nullptr);
