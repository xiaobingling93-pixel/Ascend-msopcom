...
TEST(aclrtMemcpyAsync, sanitizer_call_pre_function_with_memcpy_async_args_expect_return)
{
    ...
    HijackedFuncOfAclrtMemcpyAsyncImpl instance;
    instance.Pre(nullptr, 10, nullptr, 10, ACL_MEMCPY_HOST_TO_HOST, nullptr);
