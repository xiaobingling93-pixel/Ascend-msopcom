...
TEST(aclrtMemcpy2d, sanitizer_call_pre_function_with_memcpy2d_args_expect_return)
{
    ...
    HijackedFuncOfAclrtMemcpy2dImpl instance;
    instance.Pre(nullptr, 10, nullptr, 10, 10, 10, ACL_MEMCPY_HOST_TO_DEVICE);
