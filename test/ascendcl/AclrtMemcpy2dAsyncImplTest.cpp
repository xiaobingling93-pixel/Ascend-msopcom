...
TEST(aclrtMemcpy2dAsync, sanitizer_call_pre_function_with_memcpy2d_async_args_expect_return)
{
    ...
    HijackedFuncOfAclrtMemcpy2dAsyncImpl instance;
    instance.Pre(nullptr, 10, nullptr, 10, 10, 10, ACL_MEMCPY_HOST_TO_DEVICE, nullptr);
