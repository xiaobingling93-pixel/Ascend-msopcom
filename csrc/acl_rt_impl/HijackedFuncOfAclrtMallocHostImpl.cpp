...
HijackedFuncOfAclrtMallocHostImpl::HijackedFuncOfAclrtMallocHostImpl()
    : HijackedFuncType(AclRuntimeLibName(), "aclrtMallocHostImpl"), hostPtr_{nullptr}, size_{} {}

void HijackedFuncOfAclrtMallocHostImpl::Pre(void **hostPtr, size_t size)
{
    this->hostPtr_ = hostPtr;
    this->size_ = size;
}

aclError HijackedFuncOfAclrtMallocHostImpl::Post(aclError ret)
{
    if (IsSanitizer()) {
